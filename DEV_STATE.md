...
- 仓库当前提交：`0578cd0 docs: record staging cms closure`；该提交只更新状态文档，应用代码与已部署 Release 一致。
- 验收站应用提交：`1c7b6571ff843ef0b31b5630209489006525f9a2`（`1c7b657 fix(cms): trigger Directus field type alterations`）。
- 验收站：`https://wz.tomatopia.top`。
- 当前 Release ID：`20260815T162408Z-1c7b657`，`/version` 已确认完整 Git SHA、`staging` 环境和 CMS Schema `2026-08-phase3`。
