export const BRAND = {
  ...
  description:
    '广州新亦源供应链管理有限公司，总部位于广州，2011年成立，深耕鞋服物流15年。专注鞋服、潮玩、美妆、箱包等行业的云仓、仓配一体、退货质检和全渠道一盘货服务，合作知名服饰品牌140+，直营鞋服仓储50万㎡，配送覆盖全国6000+城市。',
...
export const STATS = [
  ...
  { value: '6000+', label: '配送覆盖城市', unit: '个', detail: '全国城市网络，次日达覆盖主要城市' },
