...
export const APPROVED_ABOUT_HISTORY_SEEDS = [
  {
    status: 'published',
    content_key: 'history-team-founded',
    sort: 1,
    year: '2011',
    subtitle: '起点·团队成立',
  ...
  {
    status: 'published',
    content_key: 'history-angel-investment',
    sort: 2,
    year: '2017',
    subtitle: '夯实·天使投资',
  ...
  {
    status: 'published',
    content_key: 'history-strategic-positioning',
    sort: 3,
    year: '2019',
    subtitle: '聚焦·战略定位',
  ...
  {
    status: 'published',
    content_key: 'history-three-pillars',
    sort: 5,
    year: '2021',
    subtitle: '协同·三架马车',
  ...
  {
    status: 'published',
    content_key: 'history-otd-launch',
    sort: 7,
    year: '2023',
    subtitle: '升级·OTD上线',
  ...
  {
    status: 'published',
    content_key: 'history-digital-upgrade',
    sort: 8,
    year: '2024',
    subtitle: '深耕·数字化升级',
  ...
  {
    status: 'published',
    content_key: 'history-cross-border',
    sort: 9,
    year: '2025',
    subtitle: '出海·数智化升级',
  ...
  {
    status: 'published',
    content_key: 'history-huawei-management',
    sort: 10,
    year: '2026',
    subtitle: '精进·管理升级',
...
export const APPROVED_ABOUT_HONOR_SEEDS = [
  {
    status: 'published',
    content_key: 'honor-cflp-council-member',
    sort: 1,
  ...
  {
    status: 'published',
    content_key: 'honor-cflp-industry-contribution',
    sort: 2,
  ...
  {
    status: 'published',
    content_key: 'honor-zhangjiang-association',
    sort: 3,
  ...
  {
    status: 'published',
    content_key: 'honor-cflp-thank-you',
    sort: 4,
  ...
  {
    status: 'published',
    content_key: 'honor-textile-chamber-member',
    sort: 5,
  ...
  {
    status: 'published',
    content_key: 'honor-footwear-supply-chain-contribution',
    sort: 6,
  ...
  {
    status: 'published',
    content_key: 'honor-haier-gold-supplier',
    sort: 8,
  ...
  {
    status: 'published',
    content_key: 'honor-guangdong-digitalization',
    sort: 9,
  ...
  {
    status: 'published',
    content_key: 'honor-ctta-recommended',
    sort: 10,
  ...
  {
    status: 'published',
    content_key: 'honor-footwear-logistics-provider',
    sort: 11,
  ...
  {
    status: 'published',
    content_key: 'honor-cflp-logistics-council',
    sort: 12,
  ...
  {
    status: 'published',
    content_key: 'honor-fashion-logistics-support',
    sort: 13,
  ...
  {
    status: 'published',
    content_key: 'honor-tax-credit-a',
    sort: 14,
  ...
  {
    status: 'published',
    content_key: 'honor-logistics-festival-top-ten',
    sort: 15,
